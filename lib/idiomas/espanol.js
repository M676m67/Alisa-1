...
//المعلمات في الأوامر
const smsRowner = () => { return `\`\`\`⌯ الـمـيـزه دي لــلـمـطـور بــس\`\`\`` }
const smsOwner = () => { return `\`\`\`⌯ الـمـيـزه دي لــلـمـطـور بــس\`\`\`` }
const smsMods = () => { return `\`\`\`⌯ الـمـيـزه دي لــلـمـطـور بــس\`\`\`` }
const smsPremium = () => { return `\`\`\`⌯ الـمـيـزه دي لــلـمـطـور بــس\`\`\`` }
const smsGroup = () => { return `\`\`\`⌯ الـمـيـزه دي فـي الــجـروبـات بـس\`\`\`` }
const smsPrivate = () => { return `\`\`\`¡¡لا يمكن استخدام هذا الأمر إلا للخصوصية!!\`\`\`` }
const smsAdmin = () => { return `\`\`\`⌯ الـمـيـزه دي لـلادمـنـز فـقـط\`\`\`` }
const smsBotAdmin = () => { return `\`\`\`⌯ ارفـعـنـي ادمـن وبـشـتـغـل لـوحـدي\`\`\`` }
const smsUnreg = () => { return `\`\`\`انـت لـسـت مـسـجـل اسـتـخـدم امـر .تسجيل لـي الـتـسـجـيل\`\`\`` }
const smsRestrict = () => { return `\`\`\`⌯ هـاذا الامـر مـقـيـد مـن قـبـل الـمـطـور\`\`\`` }
...
const smsSrevoke = () => { return '*『🔃┇تـم اعـاده تـعـيـن رابـط الـجـروب』*'}
...
//_allantilink.js
const smsTextoYT = () => { return 'BY : ALISA'} 
...
const smsCont7 = () => { return `${global.lenguajeGB['smsAvisoAG']()}لا تملك ماس كافي`}
const smsCont8 = () => { return `الماس تم استخدامها 💎`}
...
const smsCont16 = () => { return ``}
const smsCont17 = () => { return `> منع الاتصال`}
const smsCont18 = () => { return `\nتواصل مع المطور اذا كان الامر غير مقصدو\n# wa.me/201015709086`}
...
//Texto
const smsConMenu = () => { return ``} //🟡 NO CAMBIAR 
...
const smsWel2 = () => { return `فتح رسالة الترحيب للاعضاء الجدد`}
...
const smsModP2 = () => { return `الكل يقد يستخدم البوت`}
const smsModAd1 = () => { return `وضع المشرفين`}
const smsModAd2 = () => { return `وحدهم المشرفين يستطيع استخدام البوت`}
...
const smsSOLOP1 = () => { return `تغعيل خاص`}
const smsSOLOP2 = () => { return `بيشتغل خاص بس`}
const smsSOLOG1 = () => { return `جروبات بس`}
const smsSOLOG2 = () => { return `بيشتغل جروبات بس`}
const smsConfi1 = () => { return `قـائـمـتـي`}
...
const smsParaAdmins = () => { return `لـلادمـنـز`}
const smsParaAdYOw = () => { return 'لـلادمـنـز'}
const smsParaOw = () => { return 'لـلـمـطـور'}
...
const smsAutoLv4 = () => { return `الرتبة:`} 
